...
interface DssProxyActionsBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class DssProxyActionsBase extends Contract {
  ...
  interface: DssProxyActionsBaseInterface;
