...
interface VaultManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "openVault(address,address,address,address,uint256)": FunctionFragment;
  };
...
export class VaultManager extends Contract {
  ...
  functions: {
    ...
    "openVault(address,address,address,address,uint256)"(
      manager: string,
      jug: string,
      ethJoin: string,
      daiJoin: string,
